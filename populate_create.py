...
'''
import os
os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'st26_project.settings')
...
def populate():
    ...
    sl1 = SequenceListing.objects.get_or_create(fileName='file1.xml', 
                dtdVersion='1.0', 
...
#     ================================================
    ...
    sl2 = SequenceListing.objects.get_or_create(fileName='file2.xml', 
                dtdVersion='1.0', 
                softwareName='ST26 authoring tool prototype', 
                softwareVersion='0.1', 
