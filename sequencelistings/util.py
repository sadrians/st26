...
# fkdna = list(generate_list(os.path.join('resources', 'featureKey_dna.txt')))
# fkprt = list(generate_list(os.path.join('resources', 'featureKey_prt.txt')))

fkdna = list(generate_list(os.path.join(PROJECT_DIRECTORY, 'sequencelistings', 'resources', 'featureKey_dna.txt')))
fkprt = list(generate_list(os.path.join(PROJECT_DIRECTORY, 'sequencelistings', 'resources', 'featureKey_prt.txt')))
