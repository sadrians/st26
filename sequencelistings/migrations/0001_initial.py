    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('productionDate', models.DateTimeField(verbose_name=b'Production date')),
                ...
                ('filingDate', models.DateTimeField(verbose_name=b'Filing date')),
                ...
                ('earliestPriorityFilingDate', models.DateTimeField(verbose_name=b'Earliest priority filing date')),
